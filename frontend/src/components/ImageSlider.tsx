...
const ImageSlider = () => {
  ...
  return (
    ...
    w-full h-full z-10 flex flex-col justify-center items-center text-white text-4xl md:text-6xl font-bold bg-black/30">
          <div>#Big Fashion Sale</div>
          <span className="mt-5 text-2xl md:text-4xl font-bold">Limited time offer<br /> Upto 50% OFF!</span>
        </div>
      </div>
    </div>
